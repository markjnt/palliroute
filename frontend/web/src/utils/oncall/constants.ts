...
export const WEEKDAY_DUTIES: Array<{
  type: DutyType;
  label: string;
  area: OnCallArea;
  shortLabel: string;
...
export const WEEKEND_DUTIES: Array<{
  ...
  { type: "aw_nursing", label: "AW Süd", area: "Süd", shortLabel: "AW Süd" },
  {
    ...
    label: "RB Nord Tag Pflege",
    area: "Nord",
    shortLabel: "RB Nord Tag Pflege",
  },
  {
    type: "rb_nursing_weekend_night",
    label: "RB Nord Nacht Pflege",
    area: "Nord",
    shortLabel: "RB Nord Nacht Pflege",
  },
  {
    type: "rb_nursing_weekend_day",
    label: "RB Süd Tag Pflege",
    area: "Süd",
    shortLabel: "RB Süd Tag Pflege",
  },
  {
    type: "rb_nursing_weekend_night",
    label: "RB Süd Nacht Pflege",
    area: "Süd",
