...
export const UnassignedWeekendAppointments: React.FC<
  UnassignedWeekendAppointmentsProps
> = ({ appointments, onAssignArea, isAssigning }) => {
                          ...
                          <Tooltip key={area} title={`Zu ${area} verschieben`}>
                            <span>
                              <Chip
                                label={area}
                                onClick={() =>
                                  onAssignArea(appointment.id!, area)
                                }
