  ...
  return (
    <>
        ...
        >
          ...
          {(() => {
            ...
            const allTkPatientIds = new Set([
              ...tkAppointmentsByPatient.keys(),
              ...tourEmployeeTkAppointmentsByPatient.keys(),
            ]);
      ...
      {(() => {
        ...
        const allEmptyTypePatientIds = new Set([
          ...emptyTypeAppointmentsByPatient.keys(),
          ...tourEmployeeEmptyTypeAppointmentsByPatient.keys(),
        ]);
