...
export const TourContainer: React.FC<TourContainerProps> = ({
  ...
  const handleMoveUp = async (patientId: number) => {
    ...
    const appointment = appointments.find(
      (a) => a.patient_id === patientId && a.employee_id === employee.id
    );
  ...
  return (
    ...
    >
      ...
      <ReplacementConfirmationDialog
        ...
        sourceEmployee={
          employees.find((e) => e.id === replacementDialog.sourceEmployeeId) || employee
        }
        targetEmployee={
          employees.find((e) => e.id === replacementDialog.targetEmployeeId) || employee
        }
