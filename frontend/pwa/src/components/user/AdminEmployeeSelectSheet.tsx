...
export const AdminEmployeeSelectSheet: React.FC<AdminEmployeeSelectSheetProps> = ({
  open,
  onClose,
}) => {
          ...
          <Box sx={{ px: 3, pb: 2 }}>
            <Box sx={{ mb: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                Wählen Sie einen Mitarbeiter, um die App in dessen Sicht zu prüfen.
              </Typography>
            </Box>
            ...
            <Box sx={{ mt: 2 }}>
              <EmployeeFilterChips activeFilter={activeFilter} onChange={setActiveFilter} />
            </Box>
          </Box>
        </Sheet.Header>
            ...
            <Box sx={{ px: 3, pt: 2, pb: 2 }}>
              {isLoading ? (
                <Box display="flex" justifyContent="center" py={4}>
                  <Typography color="text.secondary">Lade Mitarbeiter...</Typography>
                </Box>
              ) : error ? (
                <Box display="flex" justifyContent="center" py={4}>
                ...
                <Box display="flex" flexDirection="column" alignItems="center" py={4}>
                  ...
                  <Typography color="text.secondary">Keine Mitarbeiter gefunden</Typography>
                </Box>
              ) : (
